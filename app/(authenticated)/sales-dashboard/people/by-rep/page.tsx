...
import { EodCard } from '@/components/sales/eod-card'
...
// EodCard (+ its field-classification sets) moved to
// components/sales/eod-card.tsx — shared with the DC Ads by-rep dropdown.
