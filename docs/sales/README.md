...
| [`../future-plans.md`](../future-plans.md) | **Future work, not built** — incl. the plan to replace the DC Typeform with ClickFunnels forms: API findings, the adapter contract, backfill, and what it's blocked on. |
