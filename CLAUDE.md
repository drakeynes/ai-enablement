...
- Path 3 outbound writeback (Gregory → Airtable for fields beyond accountability/NPS). Path 2 (daily-pull GET roster) shipped 2026-05-04; future writebacks for fields like csm_standing changes flowing back to Airtable would be Path 3 — deferred until a concrete need surfaces.
